...
#PA{
  ...
  <img src="hodpic.jpg" class="my-2" alt="ERROR" width="500" height="304">
  <h3>Prof. Dr. (Mrs.) Nupur Giri</h3>
</div>  
<div class="text-center">
    <a href= "hod_approval.php"> <button type="submit" class="btn btn-primary" id="PA" >PENDING EVENT APROVAL</button> </a>
    </div>
</form>
