...
<b>Pending Event for Approval at Department Level</b>
</div>
        ...
        <table class="table" id="myTable">
            ...
            <tbody>
                <?php
                    $query = "SELECT * FROM `events` WHERE `comm_type` = 'department' and `status`= 'pending'";
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this Event !")) {
                    console.log("yes");
                    window.location = `/VESITHACKS/hodapprovaldata.php?delete=${sno}`;
