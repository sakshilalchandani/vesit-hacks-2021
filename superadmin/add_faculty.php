...
//(start) jis committee/dept ke page pe jaake superadmin ne 'add member' kia, sirf wahi dept dikhna chahiye.
$cur_dept = $_GET['dept'];
//(END) jis committee/dept ke page pe jaake superadmin ne 'add member' kia, sirf wahi dept dikhna chahiye.
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong> Add a new Faculty Member Form</strong></div>
                        <form method= "post">
                        ...
                        <div class="form-group"><label for="categories" class=" form-control-label">Name</label>
                           ...
                           <div class="form-group"><label for="categories" class=" form-control-label">Department Designation</label>
                            ...
                            <div class="form-group"><label for="company" class=" form-control-label">Select a Department</label>
                            <select class="form-control" name="comm_id">
                              <option> select Department </option>
                              <?php

                                 $add_sql = "select distinct id,name,abbrv from department order by name asc";
